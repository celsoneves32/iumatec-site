...
/*
 IUMATEC PAGE CLEANUP V1.2.2 — DRY RUN ONLY
 ======================================
...
function smartphoneRule(p) {
  ...
  // Famílias específicas observadas no relatório V1.2.1.
  // Celestron NexYZ/Travel Scope são ótica/foto-vídeo, não acessórios Mobile.
  if (
    brand === "celestron" &&
    /\bnexyz\b|\btravel\s+scope\b|\bscope\b|\btelescope\b/.test(t)
  ) {
    return result(
      "SAFE",
      "Peripherie",
  ...
  // ShiftCam SnapGrip é um acessório físico para smartphone.
  if (brand === "shiftcam" && /\bsnapgrip\b/.test(t)) {
    return result(
      "SAFE",
      "Mobile",
      "Mobile Zubehör",
  ...
  if (
    ...
    !/\bsmartphones?\b|\biphone\b|\bphones?\b/.test(t)
  ) {
    return result(
      "SAFE",
      "Peripherie",
...
function runTests() {
  const tests = [
    ...
    [
      "Celestron Travel Scope to photo video",
      smartphoneRule,
      { title: "Celestron Travel Scope 80 inkl. Smartphone Adapter", brand: "Celestron", category: "Mobile", subcategory: "Smartphones" },
      "Foto & Video"
    ],
    [
      "ShiftCam SnapGrip stays mobile accessory",
      smartphoneRule,
      { title: "Shiftcam SnapGrip Creator Kit Pink", brand: "Shiftcam", category: "Mobile", subcategory: "Smartphones" },
      "Mobile Zubehör"
    ],
    [
      "Ulanzi smartphone lens stays mobile accessory",
      smartphoneRule,
      { title: "Ulanzi CL-006 Telephoto Linse 60mm für Smartphones", brand: "Ulanzi", category: "Mobile", subcategory: "Smartphones" },
      "Mobile Zubehör"
    ],
    [
      "Heat it goes review",
    ...
    [
      "XP-Pen Stifttablet to peripheral",
      tabletRule,
      { title: "XP-Pen Stifttablet Deco Pro MW Zeichentablet, Stiftdisplay", brand: "XP-Pen", category: "Mobile", subcategory: "Tablets" },
      "Zubehör"
    ],
    [
      "WWAN module",
...
const safePath = path.join(OUT, `page-cleanup-v122-safe-${stamp}.csv`);
const reviewPath = path.join(OUT, `page-cleanup-v122-review-${stamp}.csv`);

writeCsv(safePath, proposals);
writeCsv(reviewPath, reviews);

console.log("");
console.log("========== IUMATEC PAGE CLEANUP V1.2.2 ==========");
