    ...
    <main className="max-w-5xl mx-auto px-4 py-8">
      ...
      {hasItems && (
        <>
            ...
            {items.map((item: any) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  {/* Botão Entfernen grande e claro */}
                  <button
                    type="button"
                    onClick={() => removeItem(item.id)}
                    className="px-4 py-2 rounded-xl bg-red-600 text-white text-xs sm:text-sm font-semibold hover:bg-red-700 transition"
                  >
                    Entfernen
                  </button>
                </div>
          ...
          {/* Footer do carrinho: total + ações */}
          <section className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
              <button
                type="button"
                onClick={clearCart}
                className="px-4 py-2 rounded-xl border border-neutral-300 text-sm font-semibold text-neutral-700 hover:bg-neutral-100 transition"
              >
                Warenkorb leeren
              </button>
